...
import {
  requestObtenerPaginaRickMorty,
  requestObtenerUrlRickMorty,
} from "../../api/apiExterna";
import { Card } from "@rneui/base";
import TarjetaCharacter from "./TarjetaCharcter";
    ...
    if (isListaCompleta) {
      return (
        <View style={styles.pie_caja}>
          <Button
            title={`${
              isListaCompleta ? "No hay mas noticias" : "Limite alcanzado"
            }, Ir arriba`}
